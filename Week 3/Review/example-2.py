...
3) Follow along with this video about the Python Debugger (17 minutes) from the preparation 
content and use the debugger in VS Code to step through the example.py program.
"""
